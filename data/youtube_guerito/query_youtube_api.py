...
class YTstats:
    ...
    def _get_channel_content(self, limit=None, check_all_pages=True):
        ...
        idx = 0
        while(check_all_pages and npt is not None and idx < 50):
...
#YO El GUerito!! UC_3VPXVC1-ym83R3fOIMpVQ
#superholly  UC7ZWBllAI9hFTGpCT6fYcYQ
#ford quarterman UCjvWmAY6zNmMILCm1ECrnZg
# nathan seadstand UC0C926J-zjta0P5UQadxkqg
# Jan El Wero  UCMlkDJRoYCz9bNwRF9Fl2Gg
# Wero wero tv UCdqSQuBpcqN22DzlX3nGU6A
# El Gringo UCLESvRnZKpUZUPSLT5kxbzA
# Nate's Adventures  UCE_krp5me5FBJYVnh-7yVUQ
# American Boy   UCy7HFsqCNQDsniS6lZrqSNQ
# Vlog Guero      UCeGD6HoTHK2uMGhYyxXOkYw
# Dustin Luke     UCXqDGBK5sTIDil17FfCDvjw
# russos reaccionan  UCmsElbFaHyw8P_hKOMA-MJA
# gringa reacciona    UCAX8BzeLChI6WZyqaF3NDTw

api_key= os.environ.get('YT_API')

channel_ids= ['UCLESvRnZKpUZUPSLT5kxbzA','UCE_krp5me5FBJYVnh-7yVUQ','UCy7HFsqCNQDsniS6lZrqSNQ','UCeGD6HoTHK2uMGhYyxXOkYw','UCXqDGBK5sTIDil17FfCDvjw','UCAX8BzeLChI6WZyqaF3NDTw','UCmsElbFaHyw8P_hKOMA-MJA']
